...
void init(void) {
	...
	map[0][MAP_HEIGHT - 3][1] = 'B';  // 아트레이디스 본부
	map[0][MAP_HEIGHT - 3][2] = 'B';
	map[0][MAP_HEIGHT - 2][1] = 'B';
	map[0][MAP_HEIGHT - 2][2] = 'B';
	
	map[0][MAP_HEIGHT - 4][1] = 'H'; // 하베스터
	map[0][MAP_HEIGHT - 6][1] = '5'; // 스파이스



	map[0][1][MAP_WIDTH - 3] = 'B';   // 하코넨 본부
	map[0][2][MAP_WIDTH - 3] = 'B';
	map[0][1][MAP_WIDTH - 2] = 'B';
	map[0][2][MAP_WIDTH - 2] = 'B';
	
	map[0][3][MAP_WIDTH - 2] = 'H'; // 하베스터
	map[0][5][MAP_WIDTH - 2] = '5'; // 스파이스
